<template>
  ...
  <div class="geral w3-container extender-div-tela-toda w3-center" style="padding:0px;">
    ...
    <div id="visualizar">
      ...
      v-if="!editando"
      >
        <span class="w3-span w3-text-black bold-500 w3-col w3-left-align"><i class="fas fa-user"></i> : <strong class="w3-text-purple">{{nome_proprietario}}</strong></span>
        <span class="w3-span w3-margin-top w3-text-black bold-500 w3-col w3-left-align">
          <i class="fas fa-paw"></i> : <strong class="w3-text-purple">{{nome_pet}}</strong>
        </span>
        <span class="w3-span w3-margin-top w3-text-black bold-500 w3-col w3-left-align"><i class="fas fa-palette"></i> : <strong class="w3-text-purple">{{cor}}</strong></span>
        <span class="w3-span w3-margin-top w3-text-black bold-500 w3-col w3-left-align"><i class="fas fa-horse-head"></i> : <strong  class="w3-text-purple">{{raca}}</strong></span>
        <span class="w3-span w3-margin-top w3-text-black bold-500 w3-col w3-left-align"><i class="fas fa-qrcode"></i> : <strong  class="w3-text-purple">{{codigo_coleira}}</strong></span>
        <span class="w3-span w3-margin-top w3-text-black bold-500 w3-col w3-left-align"><i class="fas fa-venus"></i><i class="fas fa-mars"></i> : <strong  class="w3-text-purple">{{sexo}}</strong></span>
        <span class="w3-span w3-margin-top w3-text-black bold-500 w3-col w3-left-align ">Descrição :
          <label class="w3-border w3-round w3-col w3-container"><strong  class="w3-text-purple">{{descricao}}</strong></label>
        </span>
      </div>
    </div>
    ...
    <div class="w3-border w3-container w3-round w3-col w3-animate-zoom w3-margin-top w3-small" id="editar" v-if="editando">
      ...
      <div class="margin-top-30 w3-margin-bottom w3-left-align w3-col">
        ...
        <div>
          ...
          <span @click="status = 'd', atualizarStatusPerdido()" class="w3-text-red bold-500 w3-half">
        ...
        >
          ...
          <textarea class="w3-input w3-margin-top w3-text-black bold-500" placeholder="Descrição:" type="text" v-model="descricao"></textarea>
         </div>
    ...
    <nav class="container w3-display-bottomright w3-padding" style="position:fixed;">
      <router-link
        ...
        style="font-size:20px;padding: 4px!important; padding-left: 5px!important;"
      ...
      <label class="buttons w3-purple" for="fileInput" slot="upload-label" style="font-size:20px;padding: 4px!important; padding-left: 5px!important;" tooltip="Inserir foto">
      ...
      <a
        @click="atualizarPet()" class="buttons w3-purple"
        href="#" style="font-size:20px;padding: 4px!important; padding-left: 5px!important;" tooltip="Atualizar dados">
      ...
      <a
        ...
        style="font-size:20px;padding: 4px!important; padding-left: 5px!important;" tooltip="Excluir pet">
...
<script>
  ...
  export default {
    ...
    async created() {
      ...
      let nome_proprietario = JSON.parse(localStorage.getItem("parametros-usuario"));
      ...
      this.id_pet_dono =  detalhe_pet.id_usuario_pet_fk? detalhe_pet.id_usuario_pet_fk : detalhe_pet.id_usuario;
      ...
      this.nome_proprietario = nome_proprietario.nome_usuario + " " + nome_proprietario.sobrenome_usuario;
    ...
    methods: {
      ...
      atualizarStatusPerdido(){
         let sucesso = true
         api.put('/missingPet/'+ this.id_logado , {
          idPet: this.id_pet
        ...
        if(sucesso){
          this.$refs.enviaMensagem.exclamar("sucesso", "Status de pet já atualizados, se ouver mais detalhes edite os dados do pet.")
        }else{
      ...
      atualizarPet(){
         let sucesso = true
         api.put('/updatePet/'+ this.id_logado , {
          idPet: this.id_pet,
          img_pet: this.imagem,
      ...
      async deletarPet(questionar){
        ...
        if(questionar){
          ...
          await api.delete('/deletePet/'+ this.id_logado,{idPet: this.id_pet})
          .then(function (response) {
            sucesso = true;
      ...
      mapa(){
        if(this.id_pet_dono !== this.id_logado){
         ...
         window.location.href = 'https://www.google.com.br/maps/dir//'+this.localizacao+'/@'+this.latitude,this.longitude+',66m/data=!3m1!1e3'
      ...
      opcoes: function(value){
        ...
        if(value == 'ver'){
          this.localizacao[1] =  this.localizacao[1]+0.0000001;
          window.location.href = 'https://www.google.com.br/maps/dir//'+this.localizacao+'/@'+this.latitude,this.longitude+',66m'
